...
### This program, prices a 30-day call option on SPY, but could easily be used for any ticker or date. The program calculates historical daily return and volatility and then runs Ten-thousand sims of possible price paths foward 30 days. Each simulation uses a random shock created from a bell curve containing scaled SPY real historical volatility. Strike price is set at 5% out-of-the-money.
## Drawdown Graph
